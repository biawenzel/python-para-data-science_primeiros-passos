...
if tipo == 'E' or tipo == 'e':
    if qtd_litros < 0.0:
        ...
        total = preco_e * qtd_litros - (preco_e * qtd_litros * 0.02)  
        print(f'O total é de R${total}')      
    elif qtd_litros > 15.0:
        total = preco_e * qtd_litros - (preco_e * qtd_litros * 0.04)
        print(f'O total é de R${total}')
elif tipo == 'D' or tipo == 'd':
    if qtd_litros < 0.0:
        print('A quantidade de litros deve ser um valor maior que 0.')
    elif 0.0 < qtd_litros <= 15.0:
        total = preco_d * qtd_litros - (preco_d * qtd_litros * 0.03)
        print(f'O total é de R${total}')
    elif qtd_litros > 15.0:
        total = preco_d * qtd_litros - (preco_d * qtd_litros * 0.05)
        print(f'O total é de R${total}')
